...
export default function AddApiKeyModal({ isOpen, provider, providerName, isCompatible, isAnthropic, providerNode, authType, authHint, website, proxyPools, error, onSave, onBulkDone, onClose }) {
