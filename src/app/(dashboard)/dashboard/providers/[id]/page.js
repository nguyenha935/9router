...
import { getProviderDisplayIconSrc, markProviderIconMissing } from "@/shared/utils/providerIcon";
...
export default function ProviderDetailPage() {
  ...
  const getHeaderIconPath = () => {
    ...
    return getProviderDisplayIconSrc(providerInfo.id, providerInfo.apiType);
  };
