    ...
    >
      <div className="flex flex-col gap-3">
        <p className="text-xs text-text-muted leading-relaxed">
          ...
          <b> Retry</b> = retry lại cùng account N lần. Nếu vẫn lỗi thì chuyển account, không cooldown.
          Điền status và/hoặc text (có cả hai thì phải khớp cả hai).
        </p>
                          ...
                          <div className="w-[200px]">
                            <Field label="Số lần retry thêm">
                              <Input
                                ...
                                placeholder="1"
                                inputClassName={FIELD_CLS}
                                title="Gọi lại cùng account thêm N lần. Bỏ trống = 1."
                                aria-label="Số lần retry thêm"
                              />
                            </Field>
                          </div>
                        )}
