        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install <span data-i18n-skip="true">{branding.name}</span>, configure your providers via web dashboard, and start routing AI requests.
            </p>
            
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                <div className="landing-brand-step flex-none w-8 h-8 rounded-full flex items-center justify-center font-bold">1</div>
                <div>
                  <h4 className="font-bold text-lg">Install <span data-i18n-skip="true">{branding.name}</span></h4>
                  <p className="text-sm text-gray-500 mt-1">Run npx command to start the server instantly</p>
                </div>
              </div>
              
              <div className="flex gap-4">
                <div className="landing-brand-step flex-none w-8 h-8 rounded-full flex items-center justify-center font-bold">2</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="landing-brand-step flex-none w-8 h-8 rounded-full flex items-center justify-center font-bold">3</div>
                <div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="landing-brand-text">&gt;</span> Starting 9Router...<br/>
                  <span className="landing-brand-text">&gt;</span> Server running on <span className="text-blue-400">http://localhost:20128</span><br/>
                  <span className="landing-brand-text">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:20128/dashboard</span><br/>
